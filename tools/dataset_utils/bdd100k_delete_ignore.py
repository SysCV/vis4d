"""Script for deleting ignore regions in BDD100K COCO format annotations."""
...
def main(args: argparse.Namespace) -> None:
    """Main function. Delete ignore regions, save updated annotation files."""
    ...
    new_fn = os.path.join(
        args.save_dir, os.path.basename(args.annotation_file)
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--save-dir", help="save dir for new coco format annotation file"
    )
