...
def _cosine_distance(
    ...
    ----------
    a : array_like
        An NxL matrix of N samples of dimensionality L.
    b : array_like
        An MxL matrix of M samples of dimensionality L.
...
class NearestNeighborDistanceMetric(object):
    ...
    def __init__(
        ...
        self.budget = budget
        self.samples: Dict[int, List[NDArrayF64]] = {}
    ...
    def distance(self, features: NDArrayF64, targets: NDArrayF64):
        """Compute distance between features and targets.

        Parameters
        ----------
        features : ndarray
            An NxL matrix of N features of dimensionality L.
        targets : List[int]
