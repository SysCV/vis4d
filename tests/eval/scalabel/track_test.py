...
from vis4d.eval.scalabel import ScalabelTrackEvaluator
...
class TestBDD100KTrackEvaluator(unittest.TestCase):
    ...
    def test_shift_eval(self) -> None:
        ...
        scalabel_eval = ScalabelTrackEvaluator(annotation_path=annotations)
        assert str(scalabel_eval) == "Scalabel Tracking Evaluator"
        assert scalabel_eval.metrics == ["MOT", "MOTS"]
