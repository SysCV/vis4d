...
from vis4d.common_to_revise.datasets import bdd100k_track_map, mot_map
from vis4d.common_to_revise.models import build_faster_rcnn, build_yolox
...
def setup_model(
    ...
    if experiment == "mot17":
        ...
        track_graph = QDTrackAssociation(keep_in_memory=10)
