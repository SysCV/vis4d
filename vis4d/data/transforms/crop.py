...
class CropDepthMaps:
    ...
    def __call__(
        self, depth_maps: NDArrayF32, crop_box: NDArrayI32
    ) -> NDArrayF32:
        """Crop depth maps."""
        x1, y1, x2, y2 = crop_box
        depth_maps = depth_maps[y1:y2, x1:x2]
        return depth_maps
...
class CropOpticalFlows:
    ...
    def __call__(
        self, optical_flows: NDArrayF32, crop_box: NDArrayI32
    ) -> NDArrayF32:
        """Crop optical flows."""
        x1, y1, x2, y2 = crop_box
        optical_flows = optical_flows[y1:y2, x1:x2]
