...
from vis4d.data.datasets.nuscenes import NUSCENES_CAMS, NuScenes
...
def test_inference():
    ...
    test_data = DataPipe(
        ...
        preprocess_fn=normalize_image(sensors=NUSCENES_CAMS),
    )
    batch_fn = pad_image(sensors=NUSCENES_CAMS)
    batch_size = 2
